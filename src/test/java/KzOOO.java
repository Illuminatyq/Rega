...
public class KzOOO {
    ...
    private void fillCompanyData() {
        ...
        $$(".v-list-item__title").findBy(text("ТОО")).click();
        ...
        $("input[input-label='БИН']").setValue("771469832022");
    ...
    private void generateAndAttachFiles() throws IOException {
        ...
        $$("input[type='file']").get(1).uploadFile(new File(filePath2)); // Загружает файл FilePath2 в первый input
    }
    private void submitForm() {
        // Согласие с условиями
        $("input[aria-checked='false']").click();
        $("button[data-type='c-button']").click();
    }
}
